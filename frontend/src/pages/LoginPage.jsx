          ...
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 w-full max-w-[560px] px-5 sm:px-8 py-8">
            ...
            {loginMode !== 'password' && (
              <button
                ...
                className="flex items-center gap-1.5 text-xs font-semibold text-gray-500 hover:text-purple-600 mb-4 transition-colors"
              >
                ...
                {loginMode === 'otp_verify' && (
                  <span>
                    ...
                    <button
                      ...
                      className="text-purple-600 underline font-medium hover:text-purple-700 ml-1"
                    >
                      Change
                    </button>
                  </span>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="000000"
                      className="w-full pl-10 pr-4 py-2.5 border border-gray-300 rounded-lg text-base focus:outline-none focus:border-purple-500 transition-colors placeholder-gray-400 text-center tracking-[0.4em] font-bold"
                      autoFocus
                      required
                    />
                  </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3 rounded-full text-white font-bold text-sm transition-all duration-300 hover:shadow-lg mt-2 flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed cursor-pointer"
              ...
              <>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 py-2.5 border border-gray-200 rounded-lg hover:border-purple-400 transition-colors text-sm font-medium text-gray-700 disabled:opacity-50 cursor-pointer"
                  >
